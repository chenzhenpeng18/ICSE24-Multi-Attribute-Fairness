...
val_name = "ceo1_{}_{}_{}30.txt".format(clf_name,dataset_used,attr)
...
for r in range(20,50):
    ...
    round_result= measure_final_score(dataset_orig_test,pred_cpp,privileged_groups,unprivileged_groups, attr2)
