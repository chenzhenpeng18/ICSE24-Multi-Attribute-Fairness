...
val_name = "pr_{}_{}_{}30.txt".format(clf_name,dataset_used,attr)
...
for r in range(20,50):
    ...
    round_result = measure_final_score(dataset_orig_test, pred_prejudice, privileged_groups, unprivileged_groups, attr2)
