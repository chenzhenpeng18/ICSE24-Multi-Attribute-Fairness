...
def measure_final_score(test_df, y_test, y_pred, biased_col, attr2):
    ...
    classified_metric_pred = ClassificationMetric(tt1, tt2, unprivileged_groups=[{biased_col: 0}],
                                                  privileged_groups=[{biased_col: 1}])
